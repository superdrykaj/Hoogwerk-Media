...
export const nl = {
  ...
  soonLine: "Dronefotografie in Zaandam en Noord-Holland. Binnenkort online.",
  ...
  footer: {
    note: "Zelfstandig dronepiloot in Zaandam. Elke vlucht wordt vooraf getoetst en bevestigd.",
    workArea: "Werkgebied:",
    complianceNote: "Geregistreerd als drone-exploitant en verzekerd voor aansprakelijkheid. Bewijzen stuur ik op verzoek mee.",
    kvk: "KvK",
    vat: "BTW",
  ...
  home: {
    ...
    heroIntro: "Luchtbeelden voor vastgoed, bedrijven en bouw in Zaandam en Noord-Holland.",
    heroCta: "Bespreek uw project",
    heroWork: "Bekijk het werk",
    heroPosterAlt: "Dronebeeld van karakteristieke bebouwing en boten aan het water in de Zaanstreek.",
    ...
    workIntro: "Een selectie van dronebeelden boven stad, landschap en infrastructuur.",
    showreelLabel: "Showreel met dronebeelden boven stad, landschap en infrastructuur",
    ...
    bookingDisclaimer: "Kies een dag en tijd, vertel kort waar het om gaat, en je krijgt een bevestiging per e-mail. Zit het weer tegen, dan verzetten we de afspraak zonder kosten.",
    ...
    aboutImageAlt: "Portret van Kai Koster, dronefotograaf van Hoogbeeld Media",
    pricingEyebrow: "Tarieven",
    pricingTitle: "Indicaties, met de inhoud erbij",
    pricingNote: "Alle genoemde prijzen zijn exclusief btw. Het zijn indicaties; wat je precies nodig hebt, spreken we vooraf samen af.",
  ...
  portfolio: {
    metaTitle: "Portfolio",
    metaDescription: `Werk van ${site.name}: dronefoto's en dronevideo's voor vastgoed, bedrijven, evenementen, natuur en locaties in Zaandam en Noord-Holland.`,
    eyebrow: "Portfolio",
    title: "Werk vanuit de lucht",
    intro: (regio: string) => `Werk uit ${regio}. Filter op het soort opdracht.`,
    ...
    ctaBody: "Vertel me wat je voor ogen hebt. Een kennismaking van twintig minuten is gratis en vrijblijvend.",
    ctaAsk: "Stel een vraag",
    filterLabel: "Filter projecten op categorie",
    filterAll: "Alles",
    count: (aantal: number) => `${aantal} ${aantal === 1 ? "project" : "projecten"}`,
  ...
  project: {
    ...
    metaDescription: (locatie: string) => `Project van ${site.name} in ${locatie}.`,
    ...
    videoEmptyHint: "Voeg in de beheeromgeving een YouTube- of Vimeo-link toe bij dit project.",
  ...
  contact: {
    ...
    eyebrow: "Contact",
    title: "Even sparren?",
    intro: "Een pand, terrein of project dat vanuit de lucht beter tot zijn recht komt? Stuur een bericht. Ik antwoord meestal binnen één werkdag.",
    emailLabel: "E-mail",
    phoneLabel: "Telefoon",
  ...
  notFound: {
    ...
    body: "Deze pagina bestaat niet (meer). Misschien is de link verouderd of is er een typefout in het adres geslopen.",
  ...
  booking: {
    ...
    introService: "Kies de dienst die het beste past. Twijfel je? Begin met een gratis kennismaking.",
    introDate: "Alleen dagen met vrije tijden zijn te kiezen. Tijden in Europe/Amsterdam.",
    introDateCustom: "Kies een dag voor de kennismaking. De opnamedagen zelf plannen we in dat gesprek.",
    introDetails: "Ik gebruik deze gegevens alleen om contact met je op te nemen over deze aanvraag.",
    introDetailsCustom: "Vertel me kort waar het project uit bestaat, dan kan ik me op het gesprek voorbereiden.",
    ...
    noDaysBody: "Kijk verder vooruit met de knop 'Later', of stuur me een bericht als je iets specifieks zoekt.",
    ...
    rowProject: "Project",
    customDisclaimer: "Je plant hiermee de kennismaking. Daarin bespreken we de locaties, het aantal opnamedagen en de planning; daarna leg ik de opnamedagen vast.",
    ...
    doneMailFailed: "De bevestigingsmail is niet verstuurd. Je aanvraag staat wel binnen; ik neem contact op.",
    doneMailOff: "Je krijgt nu geen mail. De aanvraag is wel ontvangen.",
  ...
  forms: {
    ...
    locations: "Locaties",
    locationsHint: "Adres of omschrijving per plek. Weet je nog niet alles? Vul in wat je wel weet.",
    ...
    errTooMany: "Er zijn net te veel aanvragen vanaf dit adres verstuurd. Probeer het over een paar minuten opnieuw.",
    errTooManyMessages: "Er zijn net te veel berichten vanaf dit adres verstuurd. Probeer het over een paar minuten opnieuw.",
  },
  slots: {
    serviceUnavailable: "Deze dienst is niet beschikbaar.",
    invalidMoment: "Kies een geldige datum en tijd.",
    lead: (uren: number) => `Dit tijdstip ligt te dichtbij. Boek minimaal ${uren} uur van tevoren.`,
  ...
  scope: {
    intro: "Een project op maat beslaat vaak meerdere dagen. Met deze antwoorden kan ik de planning voorbereiden voordat we elkaar spreken.",
    ...
    periodHint: "Bij benadering mag ook. Een week, een maand of \u201Czodra het weer het toelaat\u201D is genoeg.",
    periodRequired: "Geef aan in welke periode het project zou moeten vallen. Bij benadering mag ook.",
  ...
  contactForm: {
    ...
    privacyNote: "Je gegevens worden alleen gebruikt om op je bericht te reageren en zijn niet zichtbaar voor andere bezoekers.",
    doneStored: "Je bericht is opgeslagen. Ik reageer meestal binnen één werkdag.",
    send: "Versturen",
    sending: "Bezig met versturen\u2026",
    mailOffNotice: "Je bericht wordt opgeslagen en gelezen, maar je krijgt geen automatische bevestiging.",
    ...
    doneMailFailed: "De bevestigingsmail is niet verstuurd. Je bericht is wel binnen.",
    doneMailOff: "Je krijgt nu geen mail. Het bericht is wel ontvangen.",
  },
  mail: {
    ...
    confirmedNotice: "Verandert er iets aan het weer of de locatie, dan neem ik op tijd contact op.",
    ...
    cancelledNotice: "Wil je een ander moment proberen? Je kunt een nieuwe aanvraag doen via de website.",
